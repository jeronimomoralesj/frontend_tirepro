      ...
      >
        <div className="flex items-center gap-2 min-w-0">
          <div className="p-1.5 rounded-lg flex-shrink-0"
            ...
            <Tag size={14} className="text-[#A374FF]" />
          </div>
        ...
        <div className="group relative cursor-pointer shrink-0 print:hidden">
          ...
          <div
            className="absolute z-20 top-full mt-2 right-0 bg-[#0A183A] text-white text-xs p-3 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 w-52 pointer-events-none shadow-xl"
