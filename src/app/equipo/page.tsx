...
export default function Equipo() {
  ...
  return (
    <div className="bg-white text-gray-900 min-h-screen overflow-x-hidden w-full">
      ...
      {/* ── FOOTER ───────────────────────────────────────────────────────────── */}
      <footer className="border-t border-gray-200 py-8 px-4 sm:px-6 lg:px-8 w-full bg-white" role="contentinfo">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            ...
            <nav aria-labelledby="ft-product">
              ...
              <ul className="space-y-2 text-xs text-gray-500">
                <li><a href="/#producto" className="hover:text-blue-600 transition-colors">Características</a></li>
                ...
                <li><a href="/calculadora" className="hover:text-blue-600 transition-colors">Calculadora CPK</a></li>
              </ul>
            </nav>
            <nav aria-labelledby="ft-legal">
              <h4 id="ft-legal" className="font-medium mb-3 text-sm">Legal</h4>
              <ul className="space-y-2 text-xs text-gray-500">
                <li><a href="/legal#terms-section" className="hover:text-blue-600 transition-colors">Términos de servicio</a></li>
                <li><a href="/legal#privacy-section" className="hover:text-blue-600 transition-colors">Política de privacidad</a></li>
            ...
            <address className="not-italic">
              ...
              <ul className="space-y-2 text-xs text-gray-500">
                <li><a href="mailto:info@tirepro.com.co" className="hover:text-blue-600 transition-colors">info@tirepro.com.co</a></li>
                <li><a href="tel:+573151349122" className="hover:text-blue-600 transition-colors">+57 315 134 9122</a></li>
                <li>Bogotá, Colombia</li>
              </ul>
            </address>
          </div>
          <div className="pt-6 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-center text-xs text-gray-500 gap-3">
