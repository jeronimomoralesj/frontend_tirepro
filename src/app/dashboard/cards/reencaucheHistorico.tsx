...
const ReencaucheHistorico: React.FC<ReencaucheHistoricoProps> = ({ tires }) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <h2 className="text-xl font-bold">Reencuache Histórico</h2>
  ...
  ">
    <p>
      Esta tabla muestra cuantos reencauches has tenido a lo largo de los últimos meses.
    </p>
  </div>
</div>
