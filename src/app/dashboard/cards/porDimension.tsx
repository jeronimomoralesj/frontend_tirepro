...
import {
  HelpCircle, ArrowDownUp, ArrowUpDown, ArrowUpAZ, Ruler, ChevronDown,
} from "lucide-react";
...
const translations = {
  es: {
    title:     "Llantas por Dimensión",
    tooltip:   "Distribución de tus llantas por dimensión (ej. 295/80R22.5). Ordena por cantidad o alfabéticamente.",
    totalDims: "dimensiones",
    sortDesc:  "Mayor",
    sortAsc:   "Menor",
    sortAlpha: "A-Z",
    showAll:   "Ver todas",
    showLess:  "Ver menos",
    noData:    "Sin datos de dimensión",
  },
};

interface PorDimensionProps {
  groupData: { [dimension: string]: number };
}

const INITIAL_VISIBLE = 10;

const PorDimension: React.FC<PorDimensionProps> = ({ groupData }) => {
