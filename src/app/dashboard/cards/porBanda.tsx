...
import {
  HelpCircle, ArrowDownUp, ArrowUpDown, ArrowUpAZ, Layers, ChevronDown,
} from "lucide-react";
...
const translations = {
  es: {
    ...
    tooltip:   "Distribución de tus llantas por diseño de banda. Ordena por cantidad o alfabéticamente.",
    totalBands: "bandas",
    sortDesc:  "Mayor",
    sortAsc:   "Menor",
    sortAlpha: "A-Z",
    ...
    >
      ...
      <div className="px-4 sm:px-5 py-3.5 flex items-center justify-between gap-2" style={{ borderBottom: '1px solid rgba(10,24,58,0.06)' }}>
        <div className="flex items-center gap-2 min-w-0">
          <div className="p-1.5 rounded-lg flex-shrink-0" style={{ background: "rgba(163,116,255,0.08)" }}>
            <Layers size={14} className="text-[#A374FF]" />
          </div>
      ...
      <div className="px-3 sm:px-5 py-3 flex items-center gap-1.5" style={{ borderBottom: '1px solid rgba(10,24,58,0.06)' }}>
        ...
        <div className="ml-auto text-[11px] text-gray-500 font-semibold tabular-nums flex-shrink-0">
          {sorted.length} {t.totalBands}
        </div>
      </div>

      {/* Horizontal-bar list — container-relative widths, no fixed minWidth */}
