...
const TireProLanding = () => {
  ...
  return (
    <div className="bg-black text-white min-h-screen">
          ...
          <div className="flex items-center justify-between h-16 sm:h-20">
            <div className="flex items-center space-x-3">
              <span className="text-lg sm:text-xl font-semibold">
                <Image src={logo} height={50} width={120} alt='logo' className='filter brightness-0 invert h-10 sm:h-12 md:h-14 w-auto'/>
              </span>
            </div>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden bg-black border-t border-white/10">
            <div className="px-4 sm:px-6 py-4 space-y-3">
              <a href="#producto" className="block text-gray-400 hover:text-white transition-colors py-2">Producto</a>
              <a href="#beneficios" className="block text-gray-400 hover:text-white transition-colors py-2">Beneficios</a>
              <a href="#planes" className="block text-gray-400 hover:text-white transition-colors py-2">Planes</a>
              <a href="#preguntas" className="block text-gray-400 hover:text-white transition-colors py-2">Preguntas</a>
              <a href="/login" className="block text-gray-400 hover:text-white transition-colors py-2">Ingresar</a>
              <a href="/companyregister">
      ...
      {/* Hero Section */}
      <section className="pt-24 sm:pt-28 md:pt-32 lg:pt-36 pb-12 sm:pb-16 md:pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8">
            ...
            <p className="text-xs sm:text-sm text-gray-500 px-4">Plan Inicio gratis para siempre • Sin tarjeta de crédito</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="text-center">
              <div className="text-3xl sm:text-4xl md:text-5xl font-semibold mb-2 bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">25%</div>
              <div className="text-gray-500 text-xs sm:text-sm">Reducción de costos</div>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl md:text-5xl font-semibold mb-2 bg-gradient-to-r from-green-400 to-green-600 bg-clip-text text-transparent">95%</div>
              <div className="text-gray-500 text-xs sm:text-sm">Precisión en predicciones</div>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl md:text-5xl font-semibold mb-2 bg-gradient-to-r from-purple-400 to-purple-600 bg-clip-text text-transparent">10x</div>
              <div className="text-gray-500 text-xs sm:text-sm">Más rápido que manual</div>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl md:text-5xl font-semibold mb-2 bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">24/7</div>
              <div className="text-gray-500 text-xs sm:text-sm">Monitoreo continuo</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="text-lg sm:text-xl text-gray-500">Simplificamos la gestión de tu flota en 4 pasos</p>
          </div>
            ...
            {process.map((item, index) => (
              <div key={index} className="relative">
                <div className="mb-4 sm:mb-6">
                  <div className="text-5xl sm:text-6xl font-bold text-white/10">{item.step}</div>
                </div>
                ...
                {index < process.length - 1 && (
                  <div className="hidden lg:block absolute top-12 -right-4 text-gray-700">
      ...
      {/* Features Section */}
      <section id="producto" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-gray-900/50 to-transparent">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold mb-3 sm:mb-4">
              Tecnología de punta
            </h2>
            <p className="text-lg sm:text-xl text-gray-500 px-4">Herramientas diseñadas para optimizar cada aspecto</p>
          </div>
      ...
      {/* Benefits Section */}
      <section id="beneficios" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 sm:space-y-6">
                {benefits.map((benefit, index) => (
                  <div key={index} className="flex items-start space-x-3 sm:space-x-4 p-3 sm:p-4 rounded-xl sm:rounded-2xl hover:bg-white/5 transition-all">
            ...
            <div className="relative order-first lg:order-last">
              ...
              <div className="absolute -bottom-6 -right-6 w-32 h-32 sm:w-48 sm:h-48 bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-2xl sm:rounded-3xl blur-2xl"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-gray-900/50 to-transparent">
          ...
          <div className="relative">
            <div className="overflow-hidden rounded-2xl sm:rounded-3xl border border-white/10 bg-white/5 p-6 sm:p-8 md:p-12 min-h-[280px] sm:min-h-[320px]">
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <p className="text-xl sm:text-2xl md:text-3xl font-light mb-6 sm:mb-8 leading-relaxed">
                    "{testimonial.quote}"
                  </p>
                  <div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-16 items-center">
            <div className="order-2 lg:order-1 relative">
              ...
              <div className="absolute top-1/2 -left-6 w-24 h-24 sm:w-32 sm:h-32 bg-blue-500/20 rounded-full blur-3xl"></div>
            </div>
            ...
            <div className="order-1 lg:order-2 space-y-6 sm:space-y-8">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300 text-sm sm:text-base">Modo offline completo</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0">
                    <Check size={14} className="text-white sm:w-4 sm:h-4" />
                  </div>
                  <span className="text-gray-300 text-sm sm:text-base">Sincronización automática</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0">
                    <Check size={14} className="text-white sm:w-4 sm:h-4" />
                  </div>
                  <span className="text-gray-300 text-sm sm:text-base">Disponible iOS y Android</span>
                </div>
              </div>
      ...
      {/* Pricing Section */}
      <section id="planes" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-gray-900/50 to-transparent">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold mb-3 sm:mb-4">
              Planes para cada etapa
            </h2>
            <p className="text-lg sm:text-xl text-gray-500 px-4">Comienza gratis y escala cuando tu flota crezca</p>
          </div>
          ...
          <div className="mt-12 sm:mt-16 text-center px-4">
            <div className="inline-flex items-center space-x-2 px-4 sm:px-6 py-2 sm:py-3 rounded-full border border-white/20 bg-white/5">
              ...
              <span className="text-xs sm:text-sm text-gray-400">Todos los planes incluyen llantas ilimitadas y actualizaciones gratis</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
        ...
        <p className='text-center text-sm sm:text-base px-4'>Si necesitas ayuda también puedes contactar a uno de nuestros aliados:</p>
        <div className='flex flex-col sm:flex-row justify-center items-center gap-4 mt-6 sm:mt-10'>
          <img className='rounded-2xl sm:rounded-3xl h-16 sm:h-20 object-contain' src='https://i0.wp.com/reencauchadoraremax.com/wp-content/uploads/2023/01/Logo30Anos_Mesa-de-trabajo-1-copia.jpg?fit=500%2C166&ssl=1' alt="Partner 1"/>
          <img className='rounded-2xl sm:rounded-3xl h-16 sm:h-20 object-contain' src='https://media.licdn.com/dms/image/v2/C4E0BAQFZkpMWoNQU1w/company-logo_200_200/company-logo_200_200/0/1630609548810?e=2147483647&v=beta&t=kVePfprWik91OQyyu6sgafGDp8uFGurAk0wG23Wac2Y' alt="Partner 2"/>
        </div>
        <hr className='mt-6 sm:mt-10 border-white/10'/>
      </div>

      {/* FAQ Section */}
      <section id="preguntas" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold mb-3 sm:mb-4">
              Preguntas frecuentes
            </h2>
            <p className="text-lg sm:text-xl text-gray-500 px-4">Todo lo que necesitas saber sobre TirePro</p>
          </div>
          ...
          <div className="space-y-3 sm:space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  <span className="font-medium pr-4 sm:pr-8 text-sm sm:text-base">{faq.q}</span>
                  <ChevronDown 
                    size={18} 
        ...
        <div className="max-w-5xl mx-auto">
          <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-white/10">
            ...
            <div className="relative p-8 sm:p-12 md:p-16 lg:p-20 text-center space-y-6 sm:space-y-8">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 pt-4 text-xs sm:text-sm text-gray-500">
      ...
      <footer className="border-t border-white/10 py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 mb-8 sm:mb-12">
            ...
            <div>
              <h4 className="font-medium mb-3 sm:mb-4 text-sm sm:text-base">Producto</h4>
            ...
            <div>
              <h4 className="font-medium mb-3 sm:mb-4 text-sm sm:text-base">Contacto</h4>
              <ul className="space-y-2 text-xs sm:text-sm text-gray-500">
