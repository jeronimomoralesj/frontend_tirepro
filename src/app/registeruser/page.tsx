            ...
            <>
              ...
              <div className="bg-gradient-to-br from-[#0A183A]/60 to-[#173D68]/40 rounded-2xl border border-[#173D68]/30 backdrop-blur-lg p-6 sm:p-8 space-y-6">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-emerald-300 text-sm">
                        Tu cuenta ha sido creada exitosamente. Ahora puedes iniciar sesión y comenzar a usar TirePro.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="text-center pt-4 border-t border-[#173D68]/30">
                  <p className="text-sm text-gray-400 mb-2">¡Ya puedes comenzar!</p>
                  <p className="text-sm text-gray-300">
                    Usa tus credenciales para iniciar sesión y acceder a todas las funcionalidades
                  </p>
                </div>
              </div>
            </>
